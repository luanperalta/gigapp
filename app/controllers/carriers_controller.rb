class CarriersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @carrier.save
        format.html { redirect_to carriers_path, notice: I18n.t('messages.created') }
  ...
  def update
    respond_to do |format|
      if @carrier.update(carrier_params)
        format.html { redirect_to carriers_path, notice: I18n.t('messages.updated') }
  ...
  def destroy
    @carrier.destroy
    respond_to do |format|
      format.html { redirect_to carriers_path, notice: I18n.t('messages.destroyed') }
